        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <form name="form_login" id="form_login" method="post" class="navbar-form navbar-right" role="form">
                        <div id="error">
                            <!-- foutmelding zal hier worden weergegeven !-->
                        </div>
                        ...
                        <button name="submit" type="submit" id="submit" class="btn btn-success">Sign in</button>
                    </form>
